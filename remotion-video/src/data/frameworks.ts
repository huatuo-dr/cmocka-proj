...
// 21 slides: cover, contenders, matrix×2, 8 frameworks×2, outro
export const SLIDE_TIMESTAMPS = [
  ...
  960,  // 9.  GTest 概览    (4s)
  1080, // 10. GTest 代码    (4s)
  1200, // 11. MockCpp 概览  (4s)
  1320, // 12. MockCpp 代码  (4s)
  1440, // 13. CppUTest 概览 (4s)
  1560, // 14. CppUTest 代码 (4s)
  1680, // 15. Check 概览    (4s)
  1800, // 16. Check 代码    (4s)
  1920, // 17. Catch2 概览   (4s)
  2040, // 18. Catch2 代码   (4s)
  2160, // 19. doctest 概览  (4s)
  2280, // 20. doctest 代码  (4s)
  2400, // 21. 总结          (4s)
];
